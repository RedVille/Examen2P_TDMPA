...
class SaveCocktails @Inject constructor(private val mealRepository: MealRepository) :
    UseCase<Boolean, List<Meal>>() {

    override suspend fun run(params: List<Meal>) = mealRepository.saveMeal(params)
